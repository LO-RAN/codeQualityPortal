 ...
 * @version   CVS: $Id: CodeSniffer.php,v 1.64 2007/12/18 23:43:42 squiz Exp $
...
class PHP_CodeSniffer
{
    ...
    public function prepareErrorReport($showWarnings=true)
    {
        ...
        foreach ($this->files as $file) {
            ...
            if ($numErrors === 0 && $numWarnings === 0 && $numInfos === 0) {
                // Prefect score!
                continue;
            }
            ...
            if ($showWarnings === true) {
                ...
                foreach ($infos as $line => $lineInfos) {
                    foreach ($lineInfos as $column => $colInfos) {
                        ...
                        if (isset($errors[$line][$column]) === true) {
                            $errors[$line][$column] = array_merge($newInfos, $errors[$line][$column]);
                        } else {
                            $errors[$line][$column] = $newInfos;
                        }
                    }
                }//end foreach
            }//end if
    ...
    public function printXMLErrorReport($showWarnings=true)
    {
        ...
        foreach ($report['files'] as $filename => $file) {
            ...
            echo ' <file name="'.$filename.'" errors="'.$file['errors'].'" warnings="'.$file['warnings'].'" infos="'.$file['infos'].'">'.PHP_EOL;
