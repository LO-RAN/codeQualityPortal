 ...
 * @version   CVS: $Id: File.php,v 1.52 2007/12/04 23:25:40 squiz Exp $
...
class PHP_CodeSniffer_File
{
    ...
    /**
     * The infos raised form PHP_CodeSniffer_Sniffs.
     *
     * @var array()
     * @see getInfos()
     */
    ...
    /**
     * The total number of infos raised.
     *
     * @var int
     */
     ...
     * @var array
     */
    protected static $_scopeOpeners = array(
                                     T_IF            => array(
     ...
     * @var array
     */
    protected static $_endScopeTokens = array(
    ...
    public function addInfo($info, $stackPtr)
    {
        ...
        $this->_infos[$lineNum][$column][] = $info;
        $this->_infoCount++;
    ...
    /**
     * Returns the number of infos raised.
     *
     * @return int
     */
    ...
    /**
     * Returns the infos raised from processing this file.
     *
     * @return array
     */
    ...
    public function getMemberProperties($stackPtr)
    {
		...
		if (!isset($this->_tokens[$ptr]) || $this->_tokens[$ptr]['code'] !== T_CLASS) {
			throw new PHP_CodeSniffer_Exception($this->_tokens[$stackPtr]['content'].' is not a class member var (filename:'.$this->_file.', line:'.$this->_tokens[$stackPtr]['line'].')'.PHP_EOL);
        }
