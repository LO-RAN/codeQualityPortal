 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Caqs_Sniffs_Metrics_CommentLineCountSniff implements PHP_CodeSniffer_Sniff
{
   ...
   /**
	...
	$line  = 0;
        ...
        for ($i = ($start + 1); $i < $end; $i++) {
            if ( in_array($tokens[$i]['type'],$find)) {
        ...
        $info = '<elt type="MET" name="'.$phpcsFile->getDeclarationName($stackPtr).'"><metric id="CLOC" value="'.$count.'"/></elt>';
