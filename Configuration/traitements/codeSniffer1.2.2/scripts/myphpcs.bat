...
php -d include_path=".;D:/Developpement/Configuration/traitements/codeSniffer;D:/Developpement/CAQS-PHP/PEAR-1.6.2" phpcs.php --standard=caqs --output=d:/Analyses/output.xml d:/Analyses/renault/revs/src/appli/
