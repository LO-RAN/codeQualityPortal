...
if (is_file(dirname(__FILE__).'/../CodeSniffer/Caqs_Override/caqsOutput.php') === true) {
 include_once dirname(__FILE__).'/../CodeSniffer/Caqs_Override/caqsOutput.php';
}
...
$phpcs = new CaqsOutputMng($verbosity, $tabWidth);
...
$phpcs->myprocess($files, $standard, array(), $local, $output);
/*switch ($report) {
case 'xml':
