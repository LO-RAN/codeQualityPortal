 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Caqs_Sniffs_Metrics_CyclomaticComplexitySniff implements PHP_CodeSniffer_Sniff
{
   ...
   /**
    ...
    {    
        ...
        for ($i = ($start + 1); $i < $end; $i++) {
            ...
            $info = '<elt type="MET" name="'.$phpcsFile->getDeclarationName($stackPtr).'"><metric id="VG" value="'.$complexity.'"/></elt>';
            $phpcsFile->addInfoWithValue($info, $stackPtr, $complexity);
