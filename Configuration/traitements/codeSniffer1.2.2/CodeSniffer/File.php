 ...
 * @version   CVS: $Id: File.php 293533 2010-01-14 05:55:31Z squiz $
...
class PHP_CodeSniffer_File
{
	...
	protected function getClassName() {
		$retour = 'CS_'.$this->_activeListener;
    ...
    public function start($contents=null)
    {
        ...
        // to save some memory.
		$this->_tokens    = null;//override
        $this->_listeners = null;//override
		//FIN DAZ
    }//end start()
	...
	public function getDeclarationName($stackPtr)
    {
		...
		if($tokenCode===T_CLASS || $tokenCode===T_INTERFACE) {
        	$token = $this->findNext(T_STRING, $stackPtr);
        	$retour = $this->_tokens[$token]['content'];
		} else if($tokenCode===T_FUNCTION && $this->isAnonymousFunction($stackPtr) === false  ){
