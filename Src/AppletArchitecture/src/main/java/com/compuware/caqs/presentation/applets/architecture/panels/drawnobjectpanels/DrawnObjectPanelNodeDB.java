 ...
 */
public class DrawnObjectPanelNodeDB extends DrawnObjectPanelNode {
     ...
     */
    public DrawnObjectPanelNodeDB( Node node) {
    ...
    private void initComponents() {//:initComponents
        ...
        this.listScrollPane.setBorder(new TitledBorder("Touched Elements"));
        ...
        //m_layerLbl.setAlignment(java.awt.Label.RIGHT);
    ...
    private void m_propertiesBtnActionPerformed(java.awt.event.ActionEvent evt) {//:event_m_propertiesBtnActionPerformed
        // Add your handling code here:
        //System.out.println("Should open an upload form");
        new TouchedWindow( this.m_node, this);
    }
