 ...
 * @author  cwfr-fdubois
 */
public class CostFormulaXmlFactory extends com.compuware.caqs.domain.calculation.quality.RuleXmlFactory {
    
    /** Creates a new instance of FormulaFactory */
    public CostFormulaXmlFactory() {
    }
    ...
    private Rule create(Node n, OperandXmlFactory operandFactory) {
        ...
        if ((n.getNodeType() == Node.ELEMENT_NODE) && (nodeName.equals(Constants.COSTFORMULA_NODE_NAME))) {
