...
/**
 * A cost formula definition.
 * @author  cwfr-fdubois
 */
public class CostFormula implements com.compuware.caqs.domain.calculation.quality.Rule {
