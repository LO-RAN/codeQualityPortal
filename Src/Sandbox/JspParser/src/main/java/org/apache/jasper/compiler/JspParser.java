...
class JspParser implements TagConstants {
	 ...
	 * The constructor
	 */
	private JspParser(ParserController pc, JspReader reader, boolean isTagFile,
	...
	public static Node.Nodes parse(ParserController pc, JspReader reader,
		...
		JspParser parser = new JspParser(pc, reader, isTagFile, directivesOnly,
				jarFileUrl);
	...
	public static Attributes parseAttributes(ParserController pc,
		...
		JspParser tmpParser = new JspParser(pc, reader, false, false, null);
