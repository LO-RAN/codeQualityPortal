...
public class GUI implements CPDListener {
	...
	private static final Object[][] languageSets = new Object[][] {
		...
		{"UNIFACE", 			new LanguageConfig() {
									public Language languageFor(LanguageFactory lf, Properties p) { return lf.createLanguage("uniface"); }
									public boolean ignoreLiteralsByDefault() { return false; }
									public String[] extensions() { return new String[] {".uniface" }; }; } },
