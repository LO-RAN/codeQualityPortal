...
public class CommandLineOptions {
    ...
    private boolean checkUnifaceFiles;
    ...
    public CommandLineOptions(String[] args) {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            } else if (args[i].equals("-uniface")) {
                checkUnifaceFiles = true;
    ...
    public String usage() {
        return PMD.EOL + PMD.EOL +
                ...
                "-uniface: check UNIFACE files; default to do not check UNIFACE files" + PMD.EOL +
    ...
    public boolean isCheckUnifaceFiles() {
        return checkUnifaceFiles;
    }
}
