...
public class PMDTask extends Task {
    ...
    private void doTask(){
        ...
        } else if(targetJDK.equals("uniface")){
            log("Targeting UNIFACE", Project.MSG_VERBOSE);
            sourceType = SourceType.UNIFACE;
        } else {
    ...
    private void validate() throws BuildException {
        ...
        if (!targetJDK.equals("1.3") && !targetJDK.equals("1.4") && !targetJDK.equals("1.5") && !targetJDK.equals("1.6") && !targetJDK.equals("1.7") && !targetJDK.equals("jsp") && !targetJDK.equals("uniface")) {
            throw new BuildException("The targetjdk attribute, if used, must be set to either '1.3', '1.4', '1.5', '1.6', '1.7', 'jsp' or 'uniface'");
        }
    }
