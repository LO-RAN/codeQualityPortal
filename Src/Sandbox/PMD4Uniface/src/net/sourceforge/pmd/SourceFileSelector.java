...
public class SourceFileSelector {
    ...
    private boolean selectUnifaceFiles = false;
    ...
    public boolean isWantedFile(String fileName) {
        ...
        if (selectUnifaceFiles
                && extensionUppercase
                .equals(SourceFileConstants.UNIFACE_EXTENSION_UPPERCASE)) {
            return true;
        }
    ...
    /**
     * @return Returns the selectUnifaceFiles.
     */
    public boolean isSelectUnifaceFiles() {
        return selectUnifaceFiles;
    }

    /**
     * @param selectUnifaceFiles The selectUnifaceFiles to set.
     */
    public void setSelectUnifaceFiles(boolean selectUnifaceFiles) {
        this.selectUnifaceFiles = selectUnifaceFiles;
    }
}
