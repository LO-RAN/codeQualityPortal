package net.sourceforge.pmd;
 ...
 public final class SourceType implements Comparable<SourceType> {
     ...
     public static final SourceType UNIFACE = new SourceType("uniface");
     
     private static SourceType[] sourceTypes = new SourceType[]{JAVA_13, JAVA_14, JAVA_15, JAVA_16, JAVA_17, JSP, UNIFACE};
