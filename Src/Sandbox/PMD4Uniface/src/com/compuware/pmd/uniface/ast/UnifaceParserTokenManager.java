...
static final long[] jjtoToken = {
   0xffffc23ffffffff9L, 0xffffffffffffffffL, 0x3ffeffL, 
};
...
/** Constructor. */
public UnifaceParserTokenManager(CharStream stream){
   input_stream = stream;
}

/** Constructor. */
public UnifaceParserTokenManager(CharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
