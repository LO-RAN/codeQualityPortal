...
<div align="center">
  ...
  <!-- the User-Driven tasks (Workflow Connector object AvailableTask) are
       ...
       UserDrivenTaskListAction. This JSP iterates through that list an each
       ...
       CompleteUserDrivenTaskAction will be started.
    -->
    ...
    <tr>
      <td align="center" width="20%">
        <logic:equal name="userdriventask" property="taskType" value="Manual">
          <html:link forward="completeUserDriven" paramId="taskID" paramName="userdriventask" paramProperty="taskId" paramScope="page">
            <bean:write name="userdriventask" property="name"/>
          </html:link>
        </logic:equal>
        <logic:equal name="userdriventask" property="taskType" value="Interactive">
          <html:link forward="completeUserDriven" paramId="taskID" paramName="userdriventask" paramProperty="taskId" paramScope="page" target="_blank">
            <bean:write name="userdriventask" property="name"/>
          </html:link>
        </logic:equal>
      </td>
      ...
      <td align="center" width="10%">
        <bean:write name="userdriventask" property="releaseVersion"/>
      </td>
    </tr>
  </logic:iterate>
