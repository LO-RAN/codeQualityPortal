 ...
 * ============= ========== ===== =======================================
 * Laurent IZAC  2010-12-23       Created.
 ************************************************************************
 */
#endregion
...
namespace com.compuware.fxcop.rules
{
    ...
    /// </summary>
    [CLSCompliant(false)]
    public class ModuleCheckRule : BaseFXCopRule
    {
        ...
        public ModuleCheckRule() : base("ModuleCheckRule") { }
        ...
        {
            //return null;
            Problem pb = new Problem(GetResolution(module.Name));
            Problems.Add(pb);
            return Problems;
        }
    }
