...
public class Token
{
    ...
    {
        return "[id=" + (id >= 127 ? (new StringBuffer(String.valueOf(id))).toString() : tokenToString(id)) + ",offset=" + offset + ",length=" + length + "]";
    }

    public static final String TOKEN_TYPES[] = {
        "NULL", "COMMENT1", "COMMENT2", "COMMENT3", "COMMENT4", "DIGIT", "FUNCTION", "INVALID", "KEYWORD1", "KEYWORD2", 
        "KEYWORD3", "KEYWORD4", "LABEL", "LITERAL1", "LITERAL2", "LITERAL3", "LITERAL4", "MARKUP", "OPERATOR"
    };
