...
public class Calls2Matrix {
	...
	/**
	* builds a call matrix from a list of call pairs.
	* It takes as input the file "CALLSTO.MODIFIED.CSV" (that will typically have been generated by Trace2Calls.java)
	* and produces as output a file "operations.matrix.csv" or "components.matrix.csv" according to isDetailed flag.
	*
	 * @param dir where the input and output files be located
	 * @param isDetailed generate matrix at component (false) level or operation (true) level
	 *
	 * @see Trace2Calls
	 */
