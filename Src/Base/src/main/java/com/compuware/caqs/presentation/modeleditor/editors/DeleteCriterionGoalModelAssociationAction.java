 ...
 * @author cwfr-dzysman
 */
public class DeleteCriterionGoalModelAssociationAction extends ManageInfosAction {
    ...
    protected JSONObject retrieveDatas(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        retour = CriterionSvc.getInstance().deleteCriterionFromGoalAndModel(idCrit, goalId, idUsa);
