 ...
 * @author cwfr-dzysman
 */
public class RetrieveModelsCriterionsForMetricAction extends ExtJSGridAjaxAction {
    ...
    protected JSONObject retrieveDatas(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (idMet != null) {
            result = MetricSvc.getInstance().retrieveAssociatedModelsAndCriterionsForMetric(idMet);
        } else {
