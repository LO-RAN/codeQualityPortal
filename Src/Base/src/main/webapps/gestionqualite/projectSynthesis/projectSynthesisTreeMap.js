...
Ext.ux.CaqsProjectTreeMapPanel = function(config) {
    // call parent constructor
    Ext.ux.CaqsProjectTreeMapPanel.superclass.constructor.call(this, config);
}; // end of Ext.ux.CaqsTreeMapPanel constructor


Ext.extend(Ext.ux.CaqsProjectTreeMapPanel, Ext.Panel, {
    layout:             'anchor',
    treemap:            undefined,
    border:             false,
    ...
    initComponent : function(){
        Ext.ux.CaqsProjectTreeMapPanel.superclass.initComponent.call(this);

        this.numberFormatConfig = '###,###.00';
        ...
        this.add(new Ext.Panel({
            border:     false,
            html:       '<div style="margin-top:10px; text-align:center;"><div class="infovis" id="projectInfovis"></div></div>'
        }));
    ...
    askValues: function() {
        ...
        Ext.Ajax.request({
            url:        requestContextPath+'/ProjectTreeMap.do?met='+tmmId + '&idFac='+color,
            scope:      this,
