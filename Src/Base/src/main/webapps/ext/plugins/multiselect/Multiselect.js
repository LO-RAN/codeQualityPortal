...
Ext.ux.Multiselect = Ext.extend(Ext.form.Field,  {
    ...
    onRender: function(ct, position){
		...
		fs.el.first().dom.style.margin = '0px 0px 0px '+(this.width - fs.el.first().dom.offsetWidth - 30)+'px';
...
Ext.ux.ItemSelector = Ext.extend(Ext.form.Field,  {
    ...
    loadDatas: function(from, to) {
        this.fromMultiselect.store.loadData(from, false);
        this.toMultiselect.store.loadData(to, false);
    },
