        ...
        onLayout : function(ct, target){
            ...
            if(n && n.isVisible()){
                ...
                if (typeof n.collapsedEl != 'undefined' && n.collapsedTitle && this.northTitleAdded == false) {
                    ...
                    var tpl  = new Ext.Template('<div class="x-panel-header" id="northCollapsedTitle" style="background-image:none;border:0px;float: left;padding: 0px 3px 4px 5px;">{txt}</div>');
