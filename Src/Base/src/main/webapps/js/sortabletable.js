...
SortableTable.prototype.sort = function (nColumn, bDescending, sSortType) {
	...
	sSortType = this.getSortType(new Number(nColumn));
...
SortableTable.numberCompare = function compare(s1, s2) {
	n1 = new Number(s1.value);
	n2 = new Number(s2.value);
	if (n1 < n2)
		return -1;
	if (n2 < n1)
		return 1;
...
// we strip spaces
// and change the comma for a point
  var n=new Number(s.replace(" ","").replace(",","."));
	return n;
};
...
// add sort types
SortableTable.prototype.addSortType("Number", SortableTable.toNumber, SortableTable.numberCompare);
