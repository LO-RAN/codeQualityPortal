 ...
 */
public class RetrieveProcessInstanceDataAction extends Action {
    ...
    public ActionForward perform(ActionMapping mapping,
        ...
        Collection instances = dao.retrieveProcessInstanceData(processId);

        request.setAttribute(RetrieveProcessInstanceDataAction.PROCESS_BEAN_COLLECTION_KEY, instances);
