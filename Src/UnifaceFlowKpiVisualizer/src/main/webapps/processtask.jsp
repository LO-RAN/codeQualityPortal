...
<head>
<title><bean:message key="process.task.title"/></title>
<link rel="stylesheet" href="css/ovtasklist.css" type="text/css">
<html:base/>
</head>
<body bgcolor="white">
<h3><bean:message key="process.task.title" /></h3>
<table cellpadding='0' cellspacing='0'>
    <tr>
        <th class="tableHeading"><bean:message key="process.instances.taskname" /></th>
    ...
    <tr>
        <td class="cellProcess">
            <bean:write name="processTaskBean" property="name" filter="true" />
        </td>
        <td class="cell">
