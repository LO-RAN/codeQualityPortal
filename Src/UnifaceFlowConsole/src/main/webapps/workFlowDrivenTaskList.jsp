...
<!-- This JSP Iterates through the workflowitembean objects that where created by the
     ...
     is processed by the ProcessTaskAction class. Together with the action, that is
     passed as a request parameter to the Action class, also the taskid is passed
     as a request parameter to the Action class.
  -->
...
<logic:iterate id="workflowitembean" name="workflowitemsbean" property="tasks" scope="request" type="com.compuware.optimal.flow.webconsole.WorkFlowItemBean">
  <tr>
    ...
    <td align="center" width="8%">
      <bean:write name="workflowitembean" property="var1Label"/>&nbsp
    </td>
    <td align="center" width="8%">
      <bean:write name="workflowitembean" property="var1"/>&nbsp
    </td>
    <td align="center" width="8%">
      <bean:write name="workflowitembean" property="var2Label"/>&nbsp
    </td>
    <td align="center" width="8%">
      <bean:write name="workflowitembean" property="var2"/>&nbsp
    </td>
    <td align="center" width="8%">
      <bean:write name="workflowitembean" property="var3Label"/>&nbsp
    </td>
    <td align="center" width="8%">
      <bean:write name="workflowitembean" property="var3"/>&nbsp
    </td>
    <td align="center" width="27%">
      <logic:equal name="workflowitembean" property="state" scope="page" value="Scheduled">
        <logic:equal name="workflowitembean" property="type" scope="page" value="Manual">
          <html:link forward="executeworkflowdriven" paramId="taskID" paramName="workflowitembean" paramProperty="id" paramScope="page">
            <bean:message key="workFlowDrivenTaskList.execute"/>
          </html:link>
        </logic:equal>
        <logic:equal name="workflowitembean" property="type" scope="page" value="Interactive">
