        ...
        extends Check
{
                        ...
                        if(nextVar.findFirstToken(TokenTypes.LITERAL_RETURN) != null){
                            ...
                            if(nextVar.findFirstToken(TokenTypes.EXPR) != null){
                                ...
                                try{
                                    ...
                                    log(aAST.getLineNo(), aAST.getColumnNo(),"erreur dans ISMethodNaming pour la fonction : "+aAST.findFirstToken(TokenTypes.IDENT ) );
                                }
    ...
    public void SameIdentFound(DetailAST id, String memberName){
        if(!id.findFirstToken(TokenTypes.IDENT ).getText().startsWith("is")  ){
            log(id.getLineNo(), id.getColumnNo(),"Attention. La méthode "+id.findFirstToken(TokenTypes.IDENT ).getText()+" devrait s'appeler : is"+memberName+"able()");
