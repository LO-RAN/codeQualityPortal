...
public final class CPPParser/*@bgen(jjtree)*/implements CPPParserTreeConstants, CPPParserConstants {/*@bgen(jjtree)*/
   ...
   */
  String GetFullyScopedName() /*throws ParseException*/
  {
     Token t = getToken(1);
   ...
   */
  boolean IsCtor() /*throws ParseException*/
  {
      return sym.IsCtor(GetFullyScopedName());
  }

  final public ASTtranslation_unit translation_unit() throws ParseException {
  ...
  jjtree.openNodeScope(jjtn000);
    try {
     ...
     if (jjte000 instanceof ParseException) {
    	 //System.out.println("err 2 : "+jjtn000.beginLine);
 ...
 /*@bgen(jjtree) external_declaration */
  ...
  boolean jjtc000 = true;
  jjtn000.setImage(GetFullyScopedName());
  
  jjtn000.setBeginLine(jj_scanpos.beginLine);
  //System.out.println(GetFullyScopedName()+" "+jjtn000.beginLine+" "+token.kind+" "+token.next.kind);
 ...
 /*@bgen(jjtree) function_definition */
   ...
   boolean jjtc000 = true;jjtn000.setImage(GetFullyScopedName());
   jjtn000.setBeginLine(jj_scanpos.beginLine);
   //System.out.println(GetFullyScopedName()+" "+jjtn000.beginLine+" "+token.kind+" "+token.next.kind);
 ...
 /*@bgen(jjtree) func_decl_def */
   ...
   boolean jjtc000 = true;jjtn000.setImage(GetFullyScopedName());
   jjtn000.setBeginLine(jj_scanpos.beginLine);
   //System.out.println("deb func : "+GetFullyScopedName()+" "+jjtn000.beginLine+" "+token.kind+" "+token.next.kind);
   jjtree.openNodeScope(jjtn000);boolean closeReqd = false;
    ...
    //System.out.println("fin func : "+GetFullyScopedName()+" "+jjtn000.beginLine+" "+token.kind+" "+token.next.kind);
    } catch (Throwable jjte000) {
    if (jjtc000) {
      jjtree.clearNodeScope(jjtn000);
      jjtc000 = false;
 ...
 /*@bgen(jjtree) linkage_specification */
  ...
  jjtn000.setImage(GetFullyScopedName());
  jjtn000.setBeginLine(jj_scanpos.beginLine);
  //System.out.println(GetFullyScopedName()+" "+jjtn000.beginLine+" "+token.kind+" "+token.next.kind+" "+token.kind+" "+token.next.kind);
  jjtree.openNodeScope(jjtn000);
    try {
  ...
  jjtree.openNodeScope(jjtn000);
    try {
      ...
      case CONST:
        ...
        jjtn000.setImage(this.token.image);jjtn000.setBeginLine(jj_scanpos.beginLine);
        break;
      case VOLATILE:
  ...
  jjtree.openNodeScope(jjtn000);
    try {
      ...
      case STATIC:
        ...
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case AUTO:
        	jjtn000.setImage("AUTO");
      	  	jjtn000.setBeginLine(jj_scanpos.beginLine);
          jj_consume_token(AUTO);
          break;
        case REGISTER:
        	jjtn000.setImage("REGISTER");
      	  	jjtn000.setBeginLine(jj_scanpos.beginLine);
          jj_consume_token(REGISTER);
          break;
        case STATIC:
        	jjtn000.setImage("STATIC");
      	  	jjtn000.setBeginLine(jj_scanpos.beginLine);
          jj_consume_token(STATIC);
          break;
        case EXTERN:
        	jjtn000.setImage("EXTERN");
      	  	jjtn000.setBeginLine(jj_scanpos.beginLine);
	          jj_consume_token(EXTERN);
	          break;
        default:
  ...
  jjtree.openNodeScope(jjtn000);String name;
    try {
      if (jj_2_59(2147483647)) {
        ...
        jjtn000.setBeginLine(this.jj_lastpos.beginLine);
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case LPARENTHESIS:
        case SCOPE:
 ...
 */
 ...
 /*@bgen(jjtree) statement */
  ...
  jjtn000.setImage(GetFullyScopedName());
  jjtn000.setBeginLine(jj_scanpos.beginLine);
  //System.out.println("statement "+GetFullyScopedName()+" "+jjtn000.beginLine+" "+token.kind+" "+token.next.kind);
  jjtree.openNodeScope(jjtn000);
    ...
    try {
      if (jj_2_92(2147483647)) {
        ...
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case LCURLYBRACE:
        	//System.out.println("{ dans statement");
          compound_statement();
          break;
        case IF:
        case SWITCH:
 ...
 /*@bgen(jjtree) compound_statement */
  ...
  jjtn000.setImage(GetFullyScopedName());
  jjtn000.setBeginLine(jj_scanpos.beginLine);
  //System.out.println("compound statement "+GetFullyScopedName()+" "+jjtn000.beginLine+" "+token.kind+" "+token.next.kind);
  jjtree.openNodeScope(jjtn000);
    try {
      jj_consume_token(LCURLYBRACE);
     sym.OpenScope(null, false);
      if (jj_2_95(1)) {
        statement_list();
        //System.out.println("fin de list of statements "+GetFullyScopedName()+" "+jjtn000.beginLine+" "+token.kind+" "+token.next.kind);
      } else {
        ;
      }
     sym.CloseScope();
     //System.out.println("fin de compound statement "+GetFullyScopedName()+" "+jjtn000.beginLine+" "+token.kind+" "+token.next.kind);
      jj_consume_token(RCURLYBRACE);
    } catch (Throwable jjte000) {
     if (jjtc000) {
       jjtree.clearNodeScope(jjtn000);
 ...
 /*@bgen(jjtree) selection_statement */
  ...
  jjtn000.setImage(GetFullyScopedName());
  jjtn000.setBeginLine(jj_scanpos.beginLine);
  //System.out.println("selection statement "+GetFullyScopedName()+" "+jjtn000.beginLine+" "+token.kind+" "+token.next.kind);
  jjtree.openNodeScope(jjtn000);
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case IF:
      ...
      case SWITCH:
        ...
        //System.out.println("consume SWITH statement");
        jj_consume_token(LPARENTHESIS);
        expression();
        jj_consume_token(RPARENTHESIS);
        statement();
  ...
  jjtree.openNodeScope(jjtn000);
    try {
      ...
      case GOTO:
        ...
        jjtn000.setImage("goto");
        jjtn000.setBeginLine(jj_lastpos.beginLine);
        jj_consume_token(ID);
        jj_consume_token(SEMICOLON);
        break;
      case CONTINUE:
        jj_consume_token(CONTINUE);
        jjtn000.setImage("continue");
        jjtn000.setBeginLine(jj_lastpos.beginLine);
        jj_consume_token(SEMICOLON);
        break;
      case BREAK:
        jj_consume_token(BREAK);
        jjtn000.setImage("break");
        jjtn000.setBeginLine(jj_lastpos.beginLine);
        jj_consume_token(SEMICOLON);
        break;
      case RETURN:
       ...
       /* jj_consume_token(RETURN);
        //System.out.println("return consommé");
        jjtn000.setImage("return");
        jjtn000.setBeginLine(jj_lastpos.beginLine);
        if (jj_2_101(1)) {
        	//System.out.println("recherche de l expression");
          expression();
          //System.out.println("expression de return consomme");
        } else {
          ;
        }
        jj_consume_token(SEMICOLON);
