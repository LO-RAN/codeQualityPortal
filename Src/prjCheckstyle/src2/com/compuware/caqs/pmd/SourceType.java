 ...
 public final class SourceType implements Comparable {
     ...
     public static final SourceType CPP = new SourceType("cpp");
     public static final SourceType PHP = new SourceType("php");
     private static SourceType[] sourceTypes = new SourceType[]{JAVA_13, JAVA_14, JAVA_15, JAVA_16, JSP, CPP, PHP};
