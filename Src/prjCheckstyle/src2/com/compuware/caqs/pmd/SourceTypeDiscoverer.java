...
public class SourceTypeDiscoverer {
    ...
    private void initialize() {
        ...
        mapExtensionOnSourceType.put(SourceFileConstants.CPP_EXTENSION_UPPERCASE, SourceType.CPP);
        mapExtensionOnSourceType.put(SourceFileConstants.JSPX_EXTENSION_UPPERCASE, SourceType.JSP);
        mapExtensionOnSourceType.put(SourceFileConstants.PHP_EXTENSION_UPPERCASE, SourceType.PHP);
