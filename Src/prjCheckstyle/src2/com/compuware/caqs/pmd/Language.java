...
public final class Language {
    ...
    private static final String CPP_RULE_LANGUAGE_NAME = "cpp";
    private static final String PHP_RULE_LANGUAGE_NAME = "php";
    ...
    public static Language CPP = new Language(CPP_RULE_LANGUAGE_NAME);
    public static Language PHP = new Language(PHP_RULE_LANGUAGE_NAME);
