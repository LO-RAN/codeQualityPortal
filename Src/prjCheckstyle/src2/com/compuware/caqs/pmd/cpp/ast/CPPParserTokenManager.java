   ...
   for (;;)
   {
     switch(curLexState)
     {
      ...
      debugStream.println("<" + lexStateNames[curLexState] + ">" + "Current character : " + TokenMgrError.addEscapes(String.valueOf(curChar)) + " (" + (int)curChar + ") at line " + input_stream.getLine() + " column " + input_stream.getColumn());
         ...
         {
           debugStream.println("   Current character matched as a " + tokenImage[11] + " token.");
            jjmatchedKind = 11;
         }
         break;
       case 3:
...
{ 127, 127, 127, 127, 127, 127, 129, 129, 129, 129, 129, 129, 129, 129, 
  129, 129, 129, 129, 129, 130, 130, 130, 130, 130, 130, 130, 130, 130, 130, 
  130, 130, 130, 132, 132, 115, 115, 116, 116, 117, 117, 118, 118, 118, 118, 
  118, 119, 119, 120, 120, 121, 121, 122, 122, 122, 122, 122, 123, 123, 123, 
  124, 124, 124, 125, 125, 125, 126, 126, 126, 126, 126, 126, 128, 127, 127, 
  127, 127, 128, 128, 128, 128, 128, 129}, 
null
, 
null
, 
null
  ...
  {
    boolean[] kindDone = new boolean[133];
    String retVal = "";
    int cnt = 0;
