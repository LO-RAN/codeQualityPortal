...
import com.compuware.caqs.pmd.cpd.FileFinder;
import com.compuware.caqs.pmd.cpd.SourceFileOrDirectoryFilter;
import com.compuware.caqs.pmd.parsers.Parser;
import com.compuware.caqs.pmd.renderers.Renderer;
import com.compuware.caqs.pmd.sourcetypehandlers.SourceTypeHandler;
import com.compuware.caqs.pmd.sourcetypehandlers.SourceTypeHandlerBroker;
...
public class PMD {
    ...
    public static void main(String[] args) {
        ...
        if(opts.isCheckJavaFiles()){
        	System.out.println("select java file");
        }else{
        	if(opts.isCheckJspFiles()){
        		System.out.println("select jsp file");
        	}else{
        		if(opts.isCheckCppFiles()){
        			System.out.println("select cpp file");
        		}else{
            		if(opts.isCheckPhpFiles()){
            			System.out.println("select php file");
            		}
            	}
        	}
        }
        ...
        fileSelector.setSelectCppFiles(opts.isCheckCppFiles());
        fileSelector.setSelectPhpFiles(opts.isCheckPhpFiles());
        List files;
