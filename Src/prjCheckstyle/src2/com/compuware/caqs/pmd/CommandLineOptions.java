...
import com.compuware.caqs.pmd.renderers.CSVRenderer;
import com.compuware.caqs.pmd.renderers.EmacsRenderer;
import com.compuware.caqs.pmd.renderers.HTMLRenderer;
import com.compuware.caqs.pmd.renderers.IDEAJRenderer;
import com.compuware.caqs.pmd.renderers.PapariTextRenderer;
import com.compuware.caqs.pmd.renderers.Renderer;
import com.compuware.caqs.pmd.renderers.SummaryHTMLRenderer;
import com.compuware.caqs.pmd.renderers.TextRenderer;
import com.compuware.caqs.pmd.renderers.VBHTMLRenderer;
import com.compuware.caqs.pmd.renderers.XMLRenderer;
import com.compuware.caqs.pmd.renderers.YAHTMLRenderer;
...
public class CommandLineOptions {
    ...
    private boolean checkJavaFiles = true;//true;
    private boolean checkJspFiles = false;//true;
    private boolean checkCppFiles = false;//false;
    private boolean checkPhpFiles = false;//false;
    private String[] args;
     ...
     * @return Returns the checkJavaFiles.
     */
    public boolean isCheckCppFiles() {
        return checkCppFiles;
    }
    ...
    /**
     * @return Returns the checkPhpFiles.
     */
    public boolean isCheckPhpFiles() {
