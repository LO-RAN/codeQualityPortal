...
import com.compuware.caqs.pmd.RuleSet;
...
import com.compuware.caqs.pmd.jaxen.DocumentNavigator;
import com.compuware.caqs.pmd.jaxen.MatchesFunction;
import com.compuware.caqs.pmd.jsp.ast.JspCharStream;
import com.compuware.caqs.pmd.jsp.ast.JspParser;
import com.compuware.caqs.pmd.cpp.ast.*;
import com.compuware.caqs.pmd.php.*;
...
public class Designer implements ClipboardOwner {
	...
	private static final Parser cppParser1_3 = new Parser() {
		public SimpleNode parse(StringReader sr) { try {
			return new CPPParser(sr).translation_unit();
		...
		private static final Parser phpParser = new Parser() {
			public SimpleNode parse(StringReader sr) { return new PHPparser(sr).PhpPage(); };
		};
	};
